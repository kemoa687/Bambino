...
class _SignupScreenState extends State<SignupScreen> {
  ...
  String txtAge = 'Enter your birthdate';
  ...
  void setImage () async {
    _image = (await NetworkAssetBundle(Uri.parse('https://i.stack.imgur.com/l60Hf.png')).load('https://i.stack.imgur.com/l60Hf.png')).buffer.asUint8List();
  }
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text('$txtAge', style: TextStyle(color: Color(0xff6e6e6e), fontSize: 17),),
                  ),
                ),
              ),
              const SizedBox(
